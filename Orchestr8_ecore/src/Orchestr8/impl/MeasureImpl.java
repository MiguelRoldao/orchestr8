 ...
 * </p>
 * <ul>
 *   <li>{@link Orchestr8.impl.MeasureImpl#getID <em>ID</em>}</li>
 *   <li>{@link Orchestr8.impl.MeasureImpl#getBeats <em>Beats</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureImpl extends MinimalEObjectImpl.Container implements Measure {
	...
	protected EClass eStaticClass() {
		return Orchestr8Package.Literals.MEASURE;
	}
	...
	public void setID(int newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Orchestr8Package.MEASURE__ID, oldID, id));
	}
	...
	public EList<Beat> getBeats() {
		if (beats == null) {
			beats = new EObjectContainmentEList<Beat>(Beat.class, this, Orchestr8Package.MEASURE__BEATS);
		}
		return beats;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Orchestr8Package.MEASURE__BEATS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Orchestr8Package.MEASURE__ID:
				return getID();
			case Orchestr8Package.MEASURE__BEATS:
				return getBeats();
		}
